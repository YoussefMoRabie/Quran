            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: nightMood?Colors.white: Color.fromARGB(196, 0, 0, 0),
                ),
              ),
              Column(
            ...
            return Column(
              children: [
                (index != 0) || (widget.sura == 0) || (widget.sura == 8)
                    ? const Text('')
                    : RetunBasmala(nightMood: nightMood,),
                Container(
                  color: index % 2 != 0
                      ? (nightMood?Colors.black:Color.fromARGB(255, 253, 251, 240))
                      : (nightMood?Color(0xff333739): Color.fromARGB(255, 253, 247, 230) ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontFamily: arabicFont,
                            color: nightMood?Colors.white: Color.fromARGB(196, 44, 44, 44),
                          ),
                        ),
                      ),
                    ],
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            }, icon: Icon(nightMood?Icons.sunny:Icons.shield_moon_outlined,color: Colors.white,))
          ],
...
class RetunBasmala extends StatelessWidget {
  final nightMood ;
  const RetunBasmala({Key? key,required this.nightMood}) ;
  @override
  Widget build(BuildContext context) {
